  ...
  <div class="timestamp-calendar-example">
    <section class="timestamp-calendar-example__summary">
      <div>
        ...
        <p>
          Build native ranges with adapter-aware helpers, then feed the resulting Timestamp objects
          into calendar views.
        </p>
      </div>
    ...
    <section class="timestamp-calendar-example__panel">
      ...
      <div class="timestamp-calendar-example__week" dir="rtl" lang="ar">
        <div
    ...
    <section class="timestamp-calendar-example__panel">
      ...
      <div class="timestamp-calendar-example__year" dir="rtl" lang="ar">
        <button
...
const visible = parseRequired('1445-09-15')
